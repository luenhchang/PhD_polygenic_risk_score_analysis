# ---------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step18-06-01_function_correlation_plot.R
# Modified from : corrplot() source code
# Author        : Xikun Han
# Date created  : 20180530
# Purpose       : Tweak corrplot::corrplot() source code to expand tl.col to 2 vectors
# Note          : 
#----------------------------------------------------------------------------------------------
# Run dependency    : 
# Type File
...
# Sys.Date() History
#----------------------------------------------------------------------------------------
# 20180920   Saved this file to RFunction folder. Changed function name from f_corrplot() to corrplot_tweaked()  
#----------------------------------------------------------------------------------------
...
corrplot_tweaked<-function (corr
