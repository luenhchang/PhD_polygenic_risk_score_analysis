#----------------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step17-04-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_one-sex-females.R
# Modified from : PRS_UKB_201711_step17-04-01_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_all-sexes.R
...
# Read *.hsq files 
fileList.sexPRS.exclu.females <- list.files(path=input.folder.path.sexPRS.exclu.females,pattern = ".hsq") # length(fileList.sexPRS.exclu.females) 240 files
...
for (i in 1:length(fileList.sexPRS.exclu.females)){
  ...
  GCTAOut <- scan(file=paste0(input.folder.path.sexPRS.exclu.females,fileName),sep="\t", what="") # Read 65 items
...
#file.copy("PRS_UKB_201711_step17-04-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_one-sex-females.R","PRS_UKB_201711_step17-04-03_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_one-sex-males.R")
