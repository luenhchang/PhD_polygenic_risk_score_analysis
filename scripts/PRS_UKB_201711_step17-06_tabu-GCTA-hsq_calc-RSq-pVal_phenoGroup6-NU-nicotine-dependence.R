#----------------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step17-01-06_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup6-NU-nicotine-dependence.R
# Modified from : PRS_UKB_201711_step17-01-03_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup5-diagMD-diagSU.R
...
# Type File
#-----------------------------------------------------------------------------------------------------
# Input Sys.glob(paste0(locGCTAOut,"*.hsq")) # 320 files
# Outpu output1/GREML1var_phenoGroup6_nicotine-dependence-19Up_result_part1_variance.csv
# Outpu output1/GREML1var_phenoGroup6_nicotine-dependence-19Up_result_part2.csv
# Outpu output1/GREML1var_phenoGroup6_nicotine-dependence-19Up_result_part3_fixedEffects.csv
#----------------------------------------------------------------------------------------
# Sys.Date()  History
#----------------------------------------------------------------------------------------
...
IDRemappedPhenoFile_IDRemappedPRSFile <- "pheno6NicotineDependenceNU-IDremapped_standardised-IDremapped-PRS-GSCAN.txt"
...
# Read *.hsq files 
filesWantList= list.files(path=locGCTAOut,pattern = ".hsq") # 320 files
...
# Iteration 1-1000 have 69 items read. Items scanned from GCTA hsq, their corresponding line number in the hsq, corresponding variable in the input file for GCTA, and values in the line of hsq 
...
for (i in 1:length(filesWantList)){
  ...
  GCTAOut <- scan(file=paste0(locGCTAOut,fileName),sep="\t", what="") # Read 67 items

  # Extract sample size as nuermic form
  sampleSize=as.numeric(get("GCTAOut")[27]) # 606
  ...
  categoricalCovars=c("wave","wave_dup","sex","impCov") # wave_dup is a copy of wave
...
#-------------------------------------------------------------------------------------#
filePrefix= "GREML1var_phenoGroup6_nicotine-dependence-19Up_result_"
...
#file.copy("PRS_UKB_201711_step17-01-03_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup5-diagMD-diagSU.R","PRS_UKB_201711_step17-01-06_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup6-.R")
