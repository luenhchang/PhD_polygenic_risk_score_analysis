#----------------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step17-07-01_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_all-sexes.R
# Modified from : 
...
# Read *.hsq files 
fileList.sexPRS.exclu.allSexes <- list.files(path=input.folder.path.sexPRS.exclu.allSexes,pattern = ".hsq") # length(fileList.sexPRS.exclu.allSexes) 360 files
...
# Iteration 1-360 have 65 items read. Items scanned from GCTA hsq, their corresponding line number in the hsq, corresponding variable in the input file for GCTA, and values in the line of hsq 
...
for (i in 1:length(fileList.sexPRS.exclu.allSexes)){
  ...
  allCovariates.allSexes <- c(inputFileNamePart3.3
                              ,quantitativCovars.allSexes
                              ,categoricalCovars.allSexes)
  ...
  allFixedEffectVar=c(depVarName,allCovariates.allSexes)
...
#file.copy("PRS_UKB_201711_step17-07-01_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_all-sexes.R","PRS_UKB_201711_step17-07-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_one-sex-females.R")
