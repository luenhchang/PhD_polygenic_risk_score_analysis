#----------------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step17-04-03_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_one-sex-males.R
# Modified from : PRS_UKB_201711_step17-04-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_one-sex-females.R
...
# Read *.hsq files 
fileList.sexPRS.exclu.males <- list.files(path=input.folder.path.sexPRS.exclu.males,pattern = ".hsq") # length(fileList.sexPRS.exclu.males) 240 files
...
# Iteration 1-240 have 59 items read. Items scanned from GCTA hsq, their corresponding line number in the hsq, corresponding variable in the input file for GCTA, and values in the line of hsq 
...
for (i in 1:length(fileList.sexPRS.exclu.males)){
  ...
  GCTAOut <- scan(file=paste0(input.folder.path.sexPRS.exclu.males,fileName),sep="\t", what="") # Read 65 items
...
#file.copy("PRS_UKB_201711_step17-04-03_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude_one-sex-males.R")
