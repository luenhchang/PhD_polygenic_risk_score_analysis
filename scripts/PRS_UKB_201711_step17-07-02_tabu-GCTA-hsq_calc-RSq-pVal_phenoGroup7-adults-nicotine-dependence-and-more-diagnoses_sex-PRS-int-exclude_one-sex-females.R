#----------------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step17-07-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_one-sex-females.R
# Modified from : PRS_UKB_201711_step17-07-01_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_all-sexes.R
...
# Type File
#-----------------------------------------------------------------------------------------------------
# Input Sys.glob(paste0(input.folder.path.sexPRS.exclu.females,"*.hsq"))
...
input.folder.path.sexPRS.exclu.females <- paste0(locGCTA
                                                  ,"output/"
                                                  ,phenotypeGroupName
...
# Output folder paths
output.folder.path.sexPRS.exclu.females <- paste0(locGCTAOut_tabulated
                                          ,phenotypeGroupName
                                          ,"_sex-PRS-interact-exclu"
                                          ,"/females-only/")
...
# Read *.hsq files 
fileList.sexPRS.exclu.females <- list.files(path=input.folder.path.sexPRS.exclu.females,pattern = ".hsq") # length(fileList.sexPRS.exclu.females) 360 files
...
for (i in 1:length(fileList.sexPRS.exclu.females)){
  ...
  GCTAOut <- scan(file=paste0(input.folder.path.sexPRS.exclu.females,fileName),sep="\t", what="") # Read 59 items
...
#file.copy("PRS_UKB_201711_step17-07-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_one-sex-females.R","PRS_UKB_201711_step17-07-03_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup7-adults-nicotine-dependence-and-more-diagnoses_sex-PRS-int-exclude_one-sex-males.R")
