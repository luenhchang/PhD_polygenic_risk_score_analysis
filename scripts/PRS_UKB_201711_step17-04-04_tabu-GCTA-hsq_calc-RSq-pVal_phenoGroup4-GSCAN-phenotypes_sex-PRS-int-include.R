#----------------------------------------------------------------------------------------------
# Program       : PRS_UKB_201711_step17-04-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-include.R
# Modified from : PRS_UKB_201711_step17-04-01_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude.R
...
# Type File
#-----------------------------------------------------------------------------------------------------
# Input Sys.glob(paste0(input.folder.path.sexPRS.inclu,"*.hsq"))
...
# Sys.Date()  History
#----------------------------------------------------------------------------------------
# 2018-12-06  Exported the 3 files above (R2 fixed)
# 2018-12-05  Exported the 3 files above (R2 all wrongly calculated as zero)
# 2018-11-24  Generated the 3 CSV files above
# 2018-05-28  Generated the 3 CSV files above
#----------------------------------------------------------------------------------------
...
fileList.sexPRS.inclu <- list.files(path=input.folder.path.sexPRS.inclu,pattern = ".hsq") # length(fileList.sexPRS.inclu) 240 files
...
file.copy(from= paste0(locGCTA,"output_tabulated/",source_folders,"/")
          ,to= loc.archive
...
unlink(paste0(locGCTA,"output_tabulated/",source_folders,"/"), recursive=TRUE)
...
# Iteration 1-240 have 67 items read. Items scanned from GCTA hsq, their corresponding line number in the hsq, corresponding variable in the input file for GCTA, and values in the line of hsq 
...
for (i in 1:length(fileList.sexPRS.inclu)){
  ...
  allFixedEffectVar <- allCovariates
...
# file.copy("PRS_UKB_201711_step17-04-01_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-exclude.R","PRS_UKB_201711_step17-04-02_tabu-GCTA-hsq_calc-RSq-pVal_phenoGroup4-GSCAN-phenotypes_sex-PRS-int-include.R")
