...
## File name: PRS_UKB_201711_step00-03_run_GWAS_BOLT-LMM_UKB3436_ageStartedSmokingInCurrentSmokers.sh
...
## Note: 
## Purpose: (1) run GWAS using BOLT-LMM for phenotype UKB3436_ageStartedSmokingInCurrentSmokers (defined at step 00-00)
## How to run this script: . $locScripts/PRS_UKB_201711_step00-03_run_GWAS_BOLT-LMM_UKB3436_ageStartedSmokingInCurrentSmokers.sh > ${locHistory}/jobSubmitted_20180324_run_GWAS_BOLT-LMM_UKB3436-ageStartedSmokingInCurrentSmokers
## Time 	Change
##--------------------------------------------------------------------------------------------------------
## 20180324	qsub jobs 5121205-5121226
## 20180323 qsub jobs 5120798-5120819 (some of these jobs maybe unfinished as requested time < run time)
...
thread=6
outpath="${locGWAS}/UKB3436_ageStartedSmokingInCurrentSmokers";

geno_dir=/reference/data/UKBB_500k/versions/HRC201803 # this is imputed UKB genotype on March 2018

phenoType="X3436_recodeMean" # column name of the phenotype variable

phenoFile="/mnt/backedup/home/lunC/data/UKBionbank_phenotype/ukb3436_ageStartedSmokingInCurrentSmokers/ukb3436.phenoUtility.recoded"
...
#cp -n $locScripts/PRS_UKB_201711_step00-03_run_GWAS_BOLT-LMM_UKB3436_ageStartedSmokingInCurrentSmokers.sh $locScripts/PRS_UKB_201711_step00-04_run_GWAS_BOLT-LMM_UKB1559_numberStDrinksPerWeek.sh